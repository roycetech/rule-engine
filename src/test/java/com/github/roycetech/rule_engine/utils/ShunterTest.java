...
public class ShunterTest {
	...
	public final void testShuntInternal_Token3()
	{
		...
		assertArrayEquals(new String[] { "true[1]", "true[0]" }, sut.getStackRPN().toArray(new String[0]));
	}
	...
	public final void testShuntInternal_closeBracket()
	{
		...
		assertArrayEquals(new String[] { "&" }, sut.getStackOperations().toArray(new String[0]));
		assertArrayEquals(new String[] { "|", "Engineer", "9", "10" }, sut.getStackRPN().toArray(new String[0]));
	}
	...
	public final void testShuntOperator()
	{
		...
		final PrivateMethodInvoker pmi = new PrivateMethodInvoker(Shunter.class, "shuntOperator", Object.class);
		pmi.<Boolean>invoke(sut, "|");

		assertArrayEquals(new String[] { "|" }, sut.getStackOperations().toArray(new String[0]));
		assertArrayEquals(new String[] { "&", "Manager", "10" }, sut.getStackRPN().toArray(new String[0]));
	}
}
