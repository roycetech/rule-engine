...
public class StringUtilTest {
	...
	{
		assertArrayEquals(new String[] { "three", null }, StringUtil.trimArray(new String[] { "three   ", null }));
	}

	@Test
	public void testtrimArray_happy()
	{
		assertArrayEquals(new String[] { "two" }, StringUtil.trimArray(new String[] { "   two  " }));
	}
