...
public class LogicHelperTest {
	...
	assertFalse(Boolean.valueOf(
		LogicHelper.performLogical(null, tokens, Operator.AND)));
    }
	...
	assertEquals(LogicHelper.IFALSE,
		LogicHelper.performLogical(null, tokens, Operator.OR));
    }
	...
	assertTrue(Boolean.valueOf(
		LogicHelper.performLogical(scenario, tokens, Operator.AND)));
    }
	...
	assertFalse(Boolean.valueOf(
		LogicHelper.performLogical(scenario, tokens, Operator.OR)));
    }
...
//    }
    ...
    /**
     * Test method for
     * {@link com.github.roycetech.rule_engine.LogicHelper#isOpenBracket(char)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.github.roycetech.rule_engine.LogicHelper#isCloseBracket(char)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.github.roycetech.rule_engine.LogicHelper#isTrue(java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.github.roycetech.rule_engine.LogicHelper#isFalse(java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.github.roycetech.rule_engine.LogicHelper#isInternal(java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.github.roycetech.rule_engine.LogicHelper#formatInternalResult(java.lang.String)}.
     */
    @Test
	...
	final PrivateMethodInvoker pmi = new PrivateMethodInvoker(
		LogicHelper.class, "evaluateOr", List.class, Token.class,
		Token.class);
    ...
    {
	final PrivateMethodInvoker pmi = new PrivateMethodInvoker(
		LogicHelper.class, "evaluateAnd", List.class, Token.class,
		Token.class);
    ...
    /**
     * Test method for
     * {@link com.github.roycetech.rule_engine.LogicHelper#performBothInternal(Token, Token, Operator)}.
     *
	...
	final PrivateMethodInvoker pmi = new PrivateMethodInvoker(
		LogicHelper.class, "performBothInternal", Token.class,
		Token.class, Operator.class);

	final String actual = pmi.<String>invoke(null, left, right,
		Operator.OR);
