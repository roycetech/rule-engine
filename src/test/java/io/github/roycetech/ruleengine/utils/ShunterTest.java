...
import io.github.roycetech.ruleengine.utils.Shunter;
...
public class ShunterTest {
	...
	/**
	 * Test method for
	 * {@link io.github.roycetech.ruleengine.utils.Shunter#shuntInternal(java.lang.Object)}.
	 */
	@Test
	public final void testShuntInternal_Token1()
	{
		...
		assertArrayEquals(new String[] { "true[0]" }, sut.getStackRPN().toArray(new String[0]));
	}
	...
	public final void testShuntInternal_Token2()
	{
		...
		assertArrayEquals(new String[] { "true[0]" }, sut.getStackRPN().toArray(new String[0]));
		assertArrayEquals(new String[] { "&" }, sut.getStackOperations().toArray(new String[0]));
	}
	 ...
	 * because in Java, the collection object used is already in the reversed order.
	 */
	@Test
	...
	{
		final Deque<Object> stackOperations = new ArrayDeque<>(Arrays.asList("&", "(", "|"));
		final Deque<Object> stackRpn = new ArrayDeque<>(Arrays.asList("Engineer", "9", "10"));
	...
	/**
	 * Test method for
	 * {@link io.github.roycetech.ruleengine.utils.Shunter#shuntClose()}.
	 *
	...
	public final void testShuntClose()
	{
		...
		final PrivateMethodInvoker pmi = new PrivateMethodInvoker(Shunter.class, "shuntClose");
	...
	/**
	 * Test method for
	 * {@link io.github.roycetech.ruleengine.utils.Shunter#shuntOperator(java.lang.String)}.
	 *
	...
	{
		final Deque<Object> stackOperations = new ArrayDeque<>(Arrays.asList("&"));
		final Deque<Object> stackRpn = new ArrayDeque<>(Arrays.asList("Manager", "10"));

		final Shunter sut = new Shunter(stackOperations, stackRpn);

		final PrivateMethodInvoker pmi = new PrivateMethodInvoker(Shunter.class, "shuntOperator",
				Object.class);
		pmi.<Boolean>invoke(sut, "|");
